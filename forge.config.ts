...
const config: ForgeConfig = {
    ...
    hooks: {
        // This piece of code was copied from: https://stackoverflow.com/questions/79435783/how-can-i-use-native-node-modules-in-my-packaged-electron-application/79445715#79445715
        // In order to make better-sqlite3 to work with packaged app
        // Electron Forge may get it to work with less efforts in version 8.0.0 as mentioned in: https://github.com/electron/forge/issues/3738
